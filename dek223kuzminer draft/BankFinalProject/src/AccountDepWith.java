...
public class AccountDepWith {
    ...
    private void setBranch_id() {
        ...
        while(!isValid) {
            try {
                System.out.println("(1/2) At which branch location was this withdrawal or deposit made: ");
                ...
                isValid = false;
                try {
                    if (branch_id.equals("1") || branch_id.equals("10001")) {
                        branch_id = "10001";
                        isValid = true;
                    } else {
                        if (branch_id.equals("2") || branch_id.equals("10002")) {
                            branch_id = "10002";
                            isValid = true;
                        } else {
