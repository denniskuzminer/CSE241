        ...
        while(!isValid) {
            ...
            if (branch_id.equals("Yes") || branch_id.equals("yes")) {
                ...
                if (branch_id.equals("No") || branch_id.equals("no")) {
                    try {
                        while (!isValid) {
                            System.out.println("(1/2) Which branch location was this purchase made at: ");
                            ...
                            try {
                                if (branch_id.equals("1")) {
                                    ...
                                    if (branch_id.equals("2")) {
                                        ...
                                        //System.out.println("Please enter 1 or 2 to indicate transaction location. ");
                                        throw new IllegalArgumentException();
                                    }
                                    isValid = true;
                                }
...
/*
    public void setType() {
        ...
        while(!isValid) {
            System.out.println("What type of transaction was this? \nEnter 1 if this was a Purchase" +
                    "\n2: Withdrawal 3: Deposit 4: Fund Transfer 5: Loan Payment 6: Card Payment   ");
            String transType = scnr.nextLine();
            switch (transType) {
                case "1":
                    transType = "Purchase";
                    isValid = true;
