...
Go to dek223kuzminer -> BankFinalProject -> src and run the following command
...
jar cfmv BankTester.jar Manifest.txt *.class

java -jar BankTester.jar
...
From here there will be a menu where you can choose from p, d/w, l, and q
